function varargout = MohrSolver(varargin)%#ok<*DEFNU>
%MOHRSOLVER    QFT functions for Mohr Solver
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @MohrSolver_OpeningFcn, ...
                   'gui_OutputFcn',  @MohrSolver_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before MohrSolver is made visible.
function MohrSolver_OpeningFcn(hObject, ~, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to MohrSolver (see VARARGIN)
...
% Choose default command line output for MohrSolver
...
% UIWAIT makes MohrSolver wait for user response (see UIRESUME)
...
function varargout = MohrSolver_OutputFcn(~, ~, handles) 
