function varargout = VirtualStrainGauge(varargin)
%VIRTUALSTRAINGAUGE    QFT functions for Virtual Strain Gauge.
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @VirtualStrainGauge_OpeningFcn, ...
                   'gui_OutputFcn',  @VirtualStrainGauge_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before VirtualStrainGauge is made visible.
function VirtualStrainGauge_OpeningFcn(hObject, ~, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to VirtualStrainGauge (see VARARGIN)
clc
movegui(hObject, 'center')

% Choose default command line output for VirtualStrainGauge
...
% UIWAIT makes VirtualStrainGauge wait for user response (see UIRESUME)
...
function varargout = VirtualStrainGauge_OutputFcn(~, ~, handles) 
...
% --- Executes when user attempts to close VirtualStrainGauge.
function VirtualStrainGauge_CloseRequestFcn(hObject, ~, handles)
