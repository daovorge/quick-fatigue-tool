...
%   Last modified 15-Sep-2017 12:11:48 GMT
    ...
    methods(Static = true)
            ...
            for i = 1:X
                switch messageID
                    ...
                    case 122.0
                        ...
                        setappdata(0, 'messageFileWarnings', 1.0)
                    case 123.0
                        if isempty(getappdata(0, 'suppress_ID123')) == 1.0
                            fprintf(fidType(i), [returnType{i}, '***WARNING: The low frequency dataset has two history points, but at least three are required for a high frequency loading', returnType{i}]);
                    ...
                    case 144.0
                        if getappdata(0, 'suppress_ID144') == 0.0
                            fprintf(fidType(i), [returnType{i}, '***WARNING: The item list file ''%s'' used with ITEMS is formatted incorrectly', returnType{i}], getappdata(0, 'hotspotFile'));
                    ...
                    case 145.0
                        if getappdata(0, 'suppress_ID145') == 0.0
                            fprintf(fidType(i), [returnType{i}, '***WARNING: The item list file ''%s'' used with ITEMS could not be found', returnType{i}], getappdata(0, 'hotspotFile'));
                            fprintf(fidType(i), ['-> All items will be analysed', returnType{i}]);
        ...
        function [] = writeLog(jobName, jobDescription, dataset,...
            ...
            fprintf(fid, 'Last modified 15-Sep-2017 12:11:48 GMT\r\n\r\n');
