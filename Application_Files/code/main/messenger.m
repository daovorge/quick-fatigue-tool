...
%   Last modified 17-Apr-2018 14:49:17 GMT
    ...
    methods(Static = true)
        ...
        function [] = writeMessage(messageID)
            ...
            for i = 1:X
                switch messageID
                    ...
                    case 311.0
                        fprintf(fidType(i), [returnType{i}, '***NOTE: Whenever DATA_CHECK=2, the fatigue definition is recalled from the Quick Fatigue Tool library', returnType{i}]);
        ...
        function [] = writeLog(jobName, jobDescription, dataset,...
            ...
            % Write file header
            try
                fprintf(fid, 'Quick Fatigue Tool 6.12-00 on machine %s (User is %s)\r\n', char(java.net.InetAddress.getLocalHost().getHostName()), char(java.lang.System.getProperty('user.name')));
            catch
                fprintf(fid, 'Quick Fatigue Tool 6.12-00\r\n');
            end
            fprintf(fid, 'MATLAB version %s\r\n\r\n', version);
            fprintf(fid, 'Copyright Louis Vallance 2018\r\n');
            fprintf(fid, 'Last modified 17-Apr-2018 14:49:17 GMT\r\n\r\n');
