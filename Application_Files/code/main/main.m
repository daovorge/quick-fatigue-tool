...
fprintf('[NOTICE] Quick Fatigue Tool 6.12-00')
fprintf('\n[NOTICE] (Copyright Louis Vallance 2018)')
fprintf('\n[NOTICE] Last modified 15-Apr-2018 12:41:53 GMT')
...
c = clock;
fprintf(fid_status, '[NOTICE] Quick Fatigue Tool 6.12-00\t%s', datestr(datenum(c(1.0), c(2.0), c(3.0), c(4.0), c(5.0), c(6.0))));
    ...
    switch algorithm
        ...
        case 4.0
            ...
            algorithm_sbbm.worstItemAnalysis(worstNodeTensor, phiOnCP,...
                ...
                planePrecision, gateTensors, tensorGate,...
                step, signConvention, s1i, s2i, s3i, rainflowMode)
        case 6.0
            % FINDLEY'S METHOD
            algorithm_findley.worstItemAnalysis(worstNodeTensor, phiOnCP,...
                thetaOnCP, signalLength, msCorrection, planePrecision,...
        ...
        case 8.0
            ...
            algorithm_bs7608.worstItemAnalysis(worstNodeTensor, phiOnCP,...
                ...
                planePrecision, gateTensors,...
                tensorGate, step, signConvention, s1i,...
                s2i, s3i, repeats)
        case 9.0 % NASALIFE
