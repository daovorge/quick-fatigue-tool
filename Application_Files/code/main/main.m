...
fprintf('\n[NOTICE] Last modified 12-Feb-2018 08:52:17 GMT')
...
c = clock;
fprintf(fid_status, '[NOTICE] Quick Fatigue Tool 6.11-12\t%s', datestr(datenum(c(1.0), c(2.0), c(3.0), c(4.0), c(5.0), c(6.0))));
