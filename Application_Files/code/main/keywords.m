    ...
    methods(Static = true)
        ...
        function [kwStr, kwStrSp, kwData] = initialize()
            ...
            kwStr = {'ITEMS', 'UNITS', 'SCALE', 'REPEATS', 'USESN', 'DESIGNLIFE',...
                'ALGORITHM', 'MSCORRECTION', 'LOADEQ', 'ELEMENTTYPE', 'SNSCALE',...
                ...
                'FATIGUERESERVEFACTOR', 'COMPOSITECRITERIA', 'YIELDCRITERION'};
            
            kwStrSp = {'ITEMS', 'UNITS', 'SCALE', 'REPEATS', 'USE SN', 'DESIGN LIFE',...
                'ALGORITHM', 'MS CORRECTION', 'LOAD EQ', 'ELEMENT TYPE', 'SN SCALE',...
                ...
                'FATIGUE RESERVE FACTOR', 'COMPOSITE CRITERIA', 'YIELD CRITERION'};
