function varargout = MultiaxialGaugeFatigue(varargin)%#ok<*DEFNU>
%MULTIAXIALGAUGEFATIGUE    QFT functions for Multiaxial Gauge Fatigue
%   These functions are used to call and operate the Multiaxial Gauge
%   Fatigue application.
%   
%   MULTIAXIALGAUGEFATIGUE is used internally by Quick Fatigue Tool. The user is
...
function MultiaxialGaugeFatigue_OpeningFcn(hObject, ~, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to MultiaxialGaugeFatigue (see VARARGIN)
...
% uiwait(handles.MultiaxialGaugeFatigue);
...
function varargout = MultiaxialGaugeFatigue_OutputFcn(~, ~, handles) 
...
close 'Multiaxial Gauge Fatigue'
...
function MultiaxialGaugeFatigue_CloseRequestFcn(hObject, ~, handles)
