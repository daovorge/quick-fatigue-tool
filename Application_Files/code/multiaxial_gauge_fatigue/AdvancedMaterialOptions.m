function varargout = AdvancedMaterialOptions(varargin)
%ADVANCEDMATERIALOPTIONS    QFT functions for Multiaxial Gauge Fatigue.
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @AdvancedMaterialOptions_OpeningFcn, ...
                   'gui_OutputFcn',  @AdvancedMaterialOptions_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before AdvancedMaterialOptions is made visible.
function AdvancedMaterialOptions_OpeningFcn(hObject, ~, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to AdvancedMaterialOptions (see VARARGIN)

% Position the GUI in the centre of the screen
movegui(hObject, 'center')

% Choose default command line output for AdvancedMaterialOptions
...
% UIWAIT makes AdvancedMaterialOptions wait for user response (see UIRESUME)
% uiwait(handles.AdvancedMaterialOptions);


% --- Outputs from this function are returned to the command line.
function varargout = AdvancedMaterialOptions_OutputFcn(~, ~, handles) 
...
close 'Advanced Material Options'
...
% --- Executes when user attempts to close AdvancedMaterialOptions.
function AdvancedMaterialOptions_CloseRequestFcn(hObject, ~, ~)
% hObject    handle to AdvancedMaterialOptions (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% --- Executes when AdvancedMaterialOptions is resized.
function AdvancedMaterialOptions_ResizeFcn(~, ~, ~)
% hObject    handle to AdvancedMaterialOptions (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
