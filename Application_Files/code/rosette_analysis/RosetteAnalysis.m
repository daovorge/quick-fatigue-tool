function varargout = RosetteAnalysis(varargin)%#ok<*DEFNU>
%ROSETTEANALYSIS    QFT functions for rosetteanalysis Analysis.
%   These functions are used to call and operate the rosetteanalysis Analysis
%   application.
%   
%   ROSETTEANALYSIS is used internally by Quick Fatigue Tool. The user is
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @RosetteAnalysis_OpeningFcn, ...
                   'gui_OutputFcn',  @RosetteAnalysis_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before RosetteAnalysis is made visible.
function RosetteAnalysis_OpeningFcn(hObject, ~, handles, varargin)
% This function has no pMenu_resultsType args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to RosetteAnalysis (see VARARGIN)
movegui(hObject, 'center')

% Choose default command line pMenu_resultsType for RosetteAnalysis
...
function varargout = RosetteAnalysis_OutputFcn(~, ~, handles) 
...
% --- Executes when user attempts to close RosetteAnalysis.
function RosetteAnalysis_CloseRequestFcn(hObject, ~, handles)
